...
export const STD_URL = 'https://std.eng.cu.edu.eg';

export const REG_URL = 'https://std.eng.cu.edu.eg/SIS/Modules/MetaLoader.aspx?path=~/SIS/Modules/Student/Registration/Registration.ascx';
...
export const navigationDOMWait: WaitForOptions = {
  timeout: 0, // means infinte timeout
  waitUntil: 'domcontentloaded',
};

export const navigationIdleWait: WaitForOptions = {
  timeout: 0,
